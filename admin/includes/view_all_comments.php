 <table class="table table-bordered table-hover">
                            <thead>
                              ...
                              while($row = mysqli_fetch_assoc($select_comments)) {
                                  ...
                                  echo "<tr>";
                                  echo "<td>". htmlentities($comment_id) . "</td>";
                                  echo "<td>". htmlentities($comment_author) . "</td>";
                                  echo "<td>". htmlentities($comment_content) . "</td>";
...
//                                  }
//                                
                                  echo "<td>". htmlentities($comment_email) . "</td>";
                                  echo "<td>". htmlentities($comment_status) . "</td>";
